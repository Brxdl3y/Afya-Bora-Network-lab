...
**Resilience & availability**: FHRP (optional HSRP/VRRP examples included) and clear interface descriptions to support troubleshooting and handoffs.
...
X-Ray	30	10.0.0.192/26	10.0.0.254
